...
Scenario: Professor should be able to add assignment
	...
	When I touch "addAssignment" if exists
		...
		When I touch the button marked "Add"
			...
			When I type "Assignment 1" into the text field with label "AssignmentName" using keyboard	
			And I pause briefly for demonstration purposes
			When I touch "Upload Assignment Later" if exists
			And I pause briefly for demonstration purposes
			Then I navigate back
			
			##############################################
			# Before I figure how to change UIDatePicker #
			# just perfore a navigate back action        #
			##############################################
